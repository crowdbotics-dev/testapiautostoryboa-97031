...
## Project Structure
    ...
    ├── testapiautostoryboa_97031  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_97031`
...
2. Clone this repo and `cd testapiautostoryboa_97031`
